...
* `flet_oop_6` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `flet_oop_6` - executable or bundle name on disk.
* `flet_oop_6` - display name shown in window titles and about app dialogs.
